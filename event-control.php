	...
	<body>
		<?php include 'includes/modal-up.inc.php'; ?>
			<div class="colorido container-fluid">
				<h3 class="pull-left" click-animate="none" click-load="event-control?event_token=<?php echo $token;?>"><span class="e-title"><?php echo $data['event_name']; ?><span class="badge colorido"><?php echo date("d M, Y",strtotime($data['event_date']));?></span></h3>
				...
				<div id="re-up" class="e-content container">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="part panel panel-default ">
								<div class="panel-heading colorido-t">
									<h4 class="text-center"><span class="ion-fork"></span>  Vendors</h4> <span class="p-edit ion-edit"> Edit</span> </div>
								<div class="panel-body">
									Under Creation
							 </div>
							</div>
						...
						<div class="col-md-6">
							<div class="part panel panel-default ">
								<div class="panel-heading colorido-t">
									<h4 class="text-center"><span class="ion-ios-people"></span>  Guests</h4> <span class="p-edit ion-ios-list-outline" click-animate="none" click-load="guests?event_token=<?php echo $token; ?>"> Manage List</span> </div>
								<div class="panel-body colorido-t text-center">
								<?php
									include 'includes/guest_stats.php'; 
									
								?>	
									<div class="col-md-6">
									<h1><?php echo $tseats; ?></h1><h4> Seats filled</h4>
									</div>
									<div class="col-md-6">
									<h1><?php echo $invite; ?></h1><h4> Invites on list</h4>
									</div>
								</div>
							</div>
						</div>
