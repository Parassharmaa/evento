...
<div class="registration-form">
  <header>
    <h1>Login</h1>
    <p click-animate="none" click-load="register">or Register</p>
  </header>
 <form>
    ...
    <div class="input-section password-section folded">
      ...
      <div class="animated-button"><span class="icon-lock"><i class="ion-locked"></i></span><span class=""><i class="ion-chevron-up"></i></span></div>
    </div>
  </form>
</div>
<script>
