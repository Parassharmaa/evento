			...
			<div class="modal-content">
			 ...
			 <form id="venue-e">
				<label>Name*</label>
			  	...
			  	<label>Address</label>
				  <textarea type="text" name="venue-address" class="form-control" placeholder=""><?php echo $data['venue_address'];?></textarea>
			  <div class="alert"></div>
			...
			<div class="modal-content">
			  ...
			  <form id="caterer-e">
				<label>Name *</label>
			  	...
			  	<label>Address</label>
				  <textarea type="text" name="caterer-address" class="form-control" placeholder=""><?php echo $data['caterer_address'];?></textarea>
			  <div class="alert"></div>
		...
		<div class="modal fade" id="up-notes" tabindex="-1" role="dialog">
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <label>Content *</label>
				  <textarea type="text" name="event-notes" class="form-control" placeholder="Enter your notes here"><?php echo $data['event_notes']; ?><?php echo $data['event_notes'];?></textarea>
			  <div class="alert"></div>
